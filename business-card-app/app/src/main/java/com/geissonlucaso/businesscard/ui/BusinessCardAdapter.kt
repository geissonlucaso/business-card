...
import com.geissonlucaso.businesscard.databinding.ItemBusinessCardBinding

class BusinessCarAdapter : ListAdapter<BusinessCard, BusinessCarAdapter.ViewHolder>(DiffCallback()) {
